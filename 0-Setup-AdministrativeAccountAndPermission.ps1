    ...
    try{
        ...
        {   
            ...
            if ($installModules) {
                ...
                Write-Host -ForegroundColor Magenta " Enable-AzureRMDiagnostics script does not exist. "
                Write-Host -ForegroundColor Magenta " Please run script with -installModules switch to install modules."
            }            
        }
